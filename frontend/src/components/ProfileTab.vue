    ...
    <div class="space-y-8">
        ...
        <div
            ...
            <div class="flex items-center gap-3 mb-6">
                ...
                <h2 class="text-2xl font-black text-neutral-900 dark:text-white">{{ t('accountInformation') }}</h2>
            </div>

            <div class="space-y-6">
                <!-- Username (read-only) -->
                <div class="space-y-2">
                    <label class="text-xs font-black uppercase tracking-widest text-neutral-400 ml-2">{{ t('username')
                    }}</label>
                    <div
        ...
        <div
            ...
            <div class="flex items-center gap-3 mb-6">
                ...
                <h2 class="text-2xl font-black text-neutral-900 dark:text-white">{{ t('changePassword') }}</h2>
            </div>
        ...
        <div
            ...
            <div class="space-y-3">
                <div v-for="category in categories" :key="category.id"
                    ...
                    <template v-else>
                        <span class="flex-1 font-bold text-neutral-900 dark:text-white">{{ category.name }}</span>
        ...
        <div
            ...
            <div class="space-y-3">
                ...
                <div v-if="habits.length === 0" class="text-center py-8 text-neutral-400 dark:text-neutral-500">
        ...
        <div
            ...
            <div class="space-y-4">
                ...
                <div v-if="archivedHabits.length === 0" class="text-center py-8 text-neutral-400 font-medium">
                    {{ t('noArchivedHabits') }}
                </div>
            </div>
        </div>
        ...
        <Teleport to="body">
            <Transition name="fade">
                <div v-if="editingHabit" class="fixed inset-0 z-50 flex items-center justify-center p-4">
                    <div class="absolute inset-0 bg-neutral-900/60 backdrop-blur-md" @click="cancelEditHabit"></div>
                    <div
                        ...
                        <div class="flex justify-between items-center mb-10">
                            <h2 class="text-3xl font-black text-neutral-900 dark:text-white">{{ t('editHabit') }}
                            </h2>
